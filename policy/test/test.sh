...
sudo ip netns exec host1 ip addr add 192.168.1.1/24 dev eth0
sudo ip netns exec host2 ip addr add 192.168.1.2/24 dev eth0

sudo ip netns exec host1 ip addr add 10.1.1.1/24 dev br0
sudo ip netns exec host2 ip addr add 10.1.2.1/24 dev br0
