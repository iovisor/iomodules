...
func (srv *DnsmonServer) handleInfoGet(r *http.Request) routeResponse {
	return routeResponse{
		body: &infoEntry{Id: srv.dataplane.Id()},
	}
}

func (srv *DnsmonServer) Handler() http.Handler {
	return srv.handler
}

func NewServer(dataplaneUri string) (*DnsmonServer, error) {
	Info.Println("DnsMon module starting")
	rtr := mux.NewRouter()
